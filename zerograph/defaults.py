...
ENGINE_BINARY_PATH = "cpg-parse"
ENGINE_MEMORY_LIMIT = "4g"
ENGINE_JAVA_OPTS = "-Xmx4G -Xms2G -XX:+UseG1GC -XX:+UseStringDeduplication -Dfile.encoding=UTF-8"
ENGINE_SERVER_HOST = "localhost"
ENGINE_SERVER_PORT = 8080
ENGINE_PORT_MIN = 13371
ENGINE_PORT_MAX = 13870
ENGINE_SERVER_INIT_SLEEP_TIME = 3.0
ENGINE_SERVER_STARTUP_TIMEOUT = 300

# Engine HTTP connection pooling defaults
...
# Storage defaults
WORKSPACE_ROOT = "/tmp/zerograph"
CLEANUP_ON_SHUTDOWN = True

# analysis engine pool (LRU eviction)
MAX_ACTIVE_ENGINE_SERVERS = 16
ENGINE_EVICTION_POLICY = "lru"
